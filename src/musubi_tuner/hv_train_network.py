...
__all__ = [
    ...
    # accelerate
    "set_seed",
    # blissful-tuner module-level helpers
...
# --- blissful-tuner module-level helpers (preserved across the v0.3.0 trainer split) ---
_lora_module_for_pissa_validation = lora_module
