...
ARCH_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "framepack": {
        ...
        "supports": {
            ...
            "v2v": False,
            "i2v": True,
            "cute_attention": False,  # FramePackNetworkTrainer.load_transformer rejects --cute
        },
        "warnings": {},
        "constraints": {},
    ...
    "kandinsky5": {
        ...
        "supports": {
            ...
            "v2v": False,
            "i2v": True,
            "cute_attention": False,  # Kandinsky-5 uses SelfAttentionEngine — no CuTE integration yet
        },
        "warnings": {},
        "constraints": {},
